...
# Définition des poids apprenables pour les 2 couches de convolution

conv1_weights = tf.Variable(
    tf.truncated_normal([5, 5, NUM_CHANNELS, 32], # filtre 5x5, profondeur 32
                        stddev=0.1,
...
# Définition des poids apprenables pour les 2 couches entièrement connectées

fc1_weights = tf.Variable(  # fully connected, profondeur 512.
...
# crée une session locale d'entrainement.
